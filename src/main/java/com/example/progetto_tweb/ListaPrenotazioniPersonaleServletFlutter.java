...
@WebServlet(name = "ListaPrenotazioniPersonaleServletFlutter", value = "/ListaPrenotazioniPersonaleServletFlutter")
public class ListaPrenotazioniPersonaleServletFlutter extends HttpServlet {
    DAO dao = null;
